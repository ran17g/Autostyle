...
jQuery(document).ready(function(){
        jQuery.ajax({
            ...
            success: function(xml) {
                var blog_articles = jQuery(xml).find('.blog-articles .recent-article:first-child, .blog-articles .recent-article:nth-child(2), .blog-articles .recent-article:nth-child(3)').appendTo(".recent-article-holder"); 
            }
        });
	...
	jQuery('.logo').clone().appendTo('.footer-img');
